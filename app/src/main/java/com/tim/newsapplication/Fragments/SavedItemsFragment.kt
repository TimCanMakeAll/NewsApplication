...
import com.tim.newsapplication.adapters.RecyclerViewAdapterSavedItems
import com.tim.newsapplication.databinding.FragmentSavedItemsBinding
...
class SavedItemsFragment : Fragment() {
    ...
    lateinit var adapter: RecyclerViewAdapterSavedItems
    ...
    override fun onCreateView(
        ...
        binding = FragmentSavedItemsBinding.inflate(layoutInflater, container, false)
...
//        }
        ...
        val recyclerView = binding.RecyclerViewSavedItems
        recyclerView.layoutManager = LinearLayoutManager(this.context)
        //adapter = RecyclerViewAdapter(names, imageLinks, newsDates, shortDescriptions)
        data.value?.let { addToList(it) }
        adapter = RecyclerViewAdapterSavedItems(names, imageLinks, newsDates, shortDescriptions)
